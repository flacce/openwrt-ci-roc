...
## 项目说明
- 默认管理地址：**`10.0.0.1`** 默认用户：**`root`** 默认密码：**`none`**
- 提交人：[@flacce](https://github.com/flacce)
- 云编译来源：[haiibo](https://github.com/haiibo/OpenWrt) [视频教程](https://www.youtube.com/watch?v=6j4ofS0GT38&t=507s)

## 仓库说明
- 参考源码仓库：[ImmortalWrt](https://github.com/laipeng668/immortalwrt) [LibWrt](https://github.com/laipeng668/openwrt-6.x)，内容大体一致。
...
- 编译大概需要 1-2 小时，编译完成后在仓库主页 [Releases](https://github.com/flacce/openwrt-ci-roc/releases) 对应 Tag 标签内下载固件。
